...
exports.loadCanvas = async (value, label = 'canvas') => {
  ow(value, ow.any(
    ow.string.nonEmpty,
    ow.object.instanceOf(global.HTMLCanvasElement)
  ).label(label))
...
exports.enableContextAntialiasing = (ctx) => {
...
exports.createImage = (width, height, fillColor = undefined) => {
